...
func (u *UserUseCase) ListUserService(input dto.UsersRequest) ([]*dto.UsersResponse, int64, dto.ResponseError) {

	res, count, err := u.user_repo.UserList(input)
	return res, count, err
}

func (u *UserUseCase) CreateNewUserService(input dto.UserInsert) dto.ResponseError {
...
func (u *UserUseCase) UpdateUserService(input dto.UserUpdate) (*user_entity.EntityUser, dto.ResponseError) {
...
func (u *UserUseCase) ChangePasswordService(input dto.ChangePassword) dto.ResponseError {
